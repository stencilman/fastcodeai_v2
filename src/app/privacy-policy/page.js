...
//                                 <p className="list-disc">Personal Identification Information: Name, email address,
//                                     phone number, etc.</p>
//                                 <p className="list-disc">Employment Details: If you are applying for a job, details
//                                     regarding your employment history, educational background, and
//                                     job qualifications.</p>
//                                 <p className="list-disc">Technical Information: Log data, IP address, browser type, and
