                ...
                <div className="flex flex-col gap-[50px] mt-[50px]">
                    ...
                    <div className="flex gap-[5px]">
                        ...
                        <p className="text-[#9EB3CF] text-lg font-bwmss01 mt-[10px]">
                            ...
                            <ul>
                                <li className="list-disc">Personal Identification Information: Name, email address,
                                    phone number, etc.</li>
                                <li className="list-disc">Employment Details: If you are applying for a job, details
                                    regarding your employment history, educational background, and
                                    job qualifications.</li>
                                <li className="list-disc">Technical Information: Log data, IP address, browser type, and
                    ...
                    <div className="flex gap-[5px]">
                        ...
                        <p className="text-[#9EB3CF] text-lg font-bwmss01 mt-[10px]">
                            ...
                            <ul>
                                ...
                                <li className="list-disc">Improve, personalise, and expand our website.</li>
                                <li className="list-disc">Understand and analyse how you use our website.</li>
                            </ul>
                        </p>
                    </div>
                </div>
                ...
                <div className="flex flex-col gap-[50px] mt-[10px]">
                    <div className="flex gap-[5px]">
                        ...
                        <p className="text-[#9EB3CF] text-lg font-bwmss01 mt-[10px]">
                            ...
                            browser.   You   can   visit  https://www.internetcookies.com,   which   contains
