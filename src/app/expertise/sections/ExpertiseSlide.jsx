...
const ExpertiseSlide = () => {
  const blurDataURL =
    "data:image/jpeg;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mMUVvL/DgACUQF9FxpdcgAAAABJRU5ErkJggg==";
  return (
        ...
        <div className="col-span-8 md:col-span-8 lg:col-span-6 flex gap-[10px] md:justify-between">
          ...
          >
            <RevealY>
              ...
              <p className="text-[#9EB3CF] text-[19px] w-[60vw] md:w-[36vw] lg:w-full  font-light pt-[15px] font-bwmss01 ">
                Our team specializes in developing cutting-edge reinforcement
                learning systems that adapt and optimize in dynamic
                environments. We collaborate closely with clients to create
                solutions that continuously improve and achieve strategic goals.
                <br />
                <br />
                Our team specializes in developing cutting-edge reinforcement
                learning systems that adapt and optimize in dynamic
