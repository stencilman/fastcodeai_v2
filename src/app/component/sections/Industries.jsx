  ...
  return (
    <div className="w-full h-[100vh] pl-[160px] pr-[127px] bg-[#00081F] flex flex-col justify-center   relative ">
      <div className="flex flex-col items-center">
        <h3 className="text-[42px] text-center leading-[45px] w-[50vw] text-white">
          Industries That Our AI Development Services Excel In
        </h3>
        <p className="text-[#9EB3CF] text-[19px] mt-[20px] text-center w-[70vw]">
      ...
      <div className="flex pt-[120px] gap-[60px]">
        ...
        >
          ...
          <p className="text-white text-[19px]">Automibile</p>
        </div>
        <div
        ...
        >
          ...
          <p className="text-white text-[19px]">Finance</p>
        </div>
        <div
          className="shadow-lg border border-[#1A2758]  w-[172px] h-[182px] rounded-[18px] flex flex-col items-center justify-center gap-[42px] "
          style={{
        ...
        >
          ...
          <p className="text-white text-[19px]">eCommerce</p>
        </div>
        <div
          className="shadow-lg border border-[#1A2758]  w-[172px] h-[182px] rounded-[18px] flex flex-col items-center justify-center gap-[42px] "
          style={{
        ...
        >
          ...
          <p className="text-white text-[19px]">Travel</p>
        </div>
        <div
          className="shadow-lg border border-[#1A2758]  w-[172px] h-[182px] rounded-[18px] flex flex-col items-center justify-center gap-[42px] "
          style={{
        ...
        >
          ...
          <p className="text-white text-[19px]">Games</p>
        </div>
      </div>
    </div>
  );
