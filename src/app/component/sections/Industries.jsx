...
const Industries = () => {
  return (
    <div className="w-full h-auto mt-[60px] md:mt-[100px] lg:mt-[50px] lg:min-h-[80vh] pt-[100px] lg:pt-0 pl-[20px] pr-[20px] md:pl-[50px] md:pr-[20px] lg:pl-[160px] lg:pr-[127px] bg-[#00081F] flex flex-col justify-center relative ">
