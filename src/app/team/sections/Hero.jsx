...
const Hero = () => {
  return (
    <div className="w-full h-[59vh] lg:h-[100vh] bg-teamHero bg-cover md:bg-cover bg-no-repeat flex pl-[20px] md:px:[50px] lg:pl-[176px] md:items-center relative pt-[80px] md:pt-0">
