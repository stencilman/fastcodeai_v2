...
const Hero = () => {
  return (
    <div className="w-full h-[59vh] md:h-[100vh] bg-teamHero bg-cover md:bg-cover bg-no-repeat flex pl-[20px] md:pl-[100px] lg:pl-[176px] md:items-center relative pt-[80px] md:pt-0">
      <div className="flex flex-col gap-[20px] justify-center md:justify-normal sm:gap-[20px] md:gap-[15px] lg:gap-[30px] ">
        ...
        Exceptional teams <br/>leads to<br/> exceptional results
        </h1>
