  ...
  return (
    <div className="w-full h-[100vh] relative bg-gradient-to-br from-[#000E32] to-[#000929] opacity-83">
      ...
      <div className="w-full bottom-28 absolute z-[1] pl-[110px]">
        <h1
          ref={ref}
          className={`text-[#F3F3F3] text-8xl pb-[20px] font-aeonik font-normal ${
            isVisible ? "translate-y-0 opacity-100" : "translate-y-20 opacity-0"
          } transition-transform duration-1000 ease-out`}
        >
          Unleash {"AI's"}<br/> Creative Potential
        </h1>
        <p
          ref={ref}
          className={`text-[#9EB3CF] text-lg items-center font-bwmss01 ${
            isVisible ? "translate-y-0 opacity-100" : "translate-y-20 opacity-0"
