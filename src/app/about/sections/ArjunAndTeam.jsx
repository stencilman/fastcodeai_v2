      ...
      <div className="w-full h-auto lg:min-h-[80vh] pt-[57px] pb-[38px] md:pb-[50px] xl:pb-[95px]   relative flex items-center gap-0 lg:gap-[10%] flex-col-reverse lg:flex-row justify-center">
        <div className=" h-full w-full lg:w-[70%] flex flex-col justify-start lg:justify-center gap-[20px] lg:gap-[26px]">
          ...
          <p className="text-lg lg:text-[1.5vw] lg:leading-[2vw] font-bwmss01 text-[#9EB3CF]">
            <b className="font-bold">Arjun Jain</b> is the Founder and Chief
            Scientist of Fast Code AI and holds a Ph.D. in Computer Science from
            the Max-Planck Institute for Informatics, Germany. His research
            intersects computer graphics, vision, and machine learning. Arjun
            also serves as an Adjunct Faculty in the CDS department at IISc,
            where he leads a deep learning research group. He has an extensive
            teaching and professional background, having taught Computer Vision
            at IIT Bombay and worked with companies like Yahoo!, Weta Digital,
            and Apple. {"Arjun's"} notable contributions include his work on
            Weta {"Digital's"} motion capture system, featured in films such as
            Steven {"Spielberg's"} {`"The Adventures of Tintin." `} His
            achievements have garnered coverage in major media outlets like
            Vogue, Wired, and The Hollywood Reporter.
          </p>
          ...
          <div className="flex flex-col md:flex-row gap-[10vw] md:gap-[0px] w-full items-center z-[3]">
            <div className=" w-[100%] md:w-[45%]">
              ...
              <p className="text-[#9EB3CF] w-[80%] text-lg font-bwmss01 font-light mt-[15px] md:mt-[30px]">
                Our team is composed of seasoned professionals, each with
                extensive research backgrounds. We are proud authors of
                influential papers and active contributors to open-source
                initiatives. Each member has been carefully selected from top
                universities, emphasizing our commitment to innovative problem
                solvers who excel in their fields.
              </p>
