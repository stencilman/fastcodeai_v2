...
const Believe = () => {
  return (
    <div className="w-full h-[80vh] lg:h-[100vh]  relative bg-[#00081F] flex flex-col justify-center">
      {/* Shadow */}
      ...
      <div className="flex flex-col justify-center items-center gap-[50px]">
        ...
        <div className="w-[90%] md:w-[60%] lg:w-[50%] flex items-center gap-[30px]">
          {/* Number */}
          ...
          <div className="flex w-[90%] items-center">
            ...
            {/* Scroll */}
            <div className="h-full w-[20%] md:w-[10%] pl-[20px] flex flex-col justify-center">
