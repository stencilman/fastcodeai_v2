            ...
            <div className="md:w-[621%] md:max-w-[822px] flex flex-col gap-[30px] ">
              ...
              >
                ...
                <p className="text-[#9EB3CF] text-lg font-bwmss01">
                  ...
                  in Delhi, nearly a decade after my post-doc days at #NYU,
                  where I worked with him. In his talk, Yann discussed the
                  limitations of Large Language Models (LLMs) and believing that
                  its not enough to achieve Artificial General Intelligence
                  (AGI). He pointed out that LLMs treat both simple and complex
                  problems with similar computational efforts, which can be
                  inefficient. He argued that the {"chain of thought"} is just a
                  creative hack to this issue.
                </p>

                <p className="text-[#9EB3CF] text-lg font-bwmss01">
                  Yann highlighted the sheer volume of data that LLMs are
                  trained on—approximately 6 x 10^13 bytes which is almost all
                  of the internet, which would take thousands of human hours to
                  process. To provide a comparison, a typical four-year-old
                  processes an immense amount of visual data in just 16,000
                  hours of life, at 2 megapixels per image captured by the eyes.
                  This context underscores the current limitations and the need
                  for progress beyond purely text-based training.
                </p>
                <p className="text-[#9EB3CF] text-lg font-bwmss01">
                  ...
                  intelligence, complete with a world model and the ability to
                  plan.
                </p>
                <p className="text-[#9EB3CF] text-lg font-bwmss01">
