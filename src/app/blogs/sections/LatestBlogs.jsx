      ...
      <div className="grid grid-cols-3 grid-rows-3 gap-7 w-full">
        ...
        <Link href="/blogs/why-ai">
          <div className="col-start-3 ">
            <div className="bg-[#104E62] rounded-[18px] w-[403px] h-[327px] relative p-[20px]">
              <div className="absolute bottom-[20px]">
                <h3 className="text-white text-2xl font-aeonik tracking-wide mb-[15px]">
        ...
        <Link href="/blogs/why-ai">
          <div className="row-start-2">
            <div className="w-[402px] h-[328px] bg-no-repeat bg-blog2 relative p-[20px]">
              <div className="absolute bottom-[20px]">
                <h3 className="text-white text-2xl font-aeonik tracking-wide mb-[15px]">
        ...
        <Link href="/blogs/why-ai">
          <div className="row-start-2">
            <div className="bg-[#001D3F] rounded-[18px] w-[403px] h-[327px] relative p-[20px]">
              <div className="absolute bottom-[20px]">
                <h3 className="text-white text-2xl font-aeonik tracking-wide mb-[15px]">
                  Oil & Gas EPC - Digitizing P&ID
                </h3>
        ...
        <Link href="/blogs/why-ai">
          <div className="row-start-2">
            <div className="w-[402px] h-[328px] bg-no-repeat bg-blog3 relative p-[20px]">
              <div className="absolute bottom-[20px]">
                <h3 className="text-white text-2xl font-aeonik tracking-wide mb-[15px]">
                  How to deal with Unknown Classes during classification?
                </h3>
        ...
        <Link href="/blogs/why-ai">
          <div className="row-start-3">
            <div className="bg-[#122057] rounded-[18px] w-[403px] h-[327px] relative p-[20px]">
              <div className="absolute bottom-[20px]">
                <h3 className="text-white text-2xl font-aeonik tracking-wide mb-[15px]">
                  The Dilemma: To ML or Not to ML?
                </h3>
        ...
        <Link href="/blogs/why-ai">
          <div className="col-span-2 ">
            <div className="w-[833px] h-[327px] bg-no-repeat bg-blog4 relative p-[20px]">
              <div className="absolute bottom-[20px]">
                <h3 className="text-white text-2xl font-aeonik tracking-wide mb-[15px]">
                  How to deal with Unknown Classes during classification?
                </h3>
