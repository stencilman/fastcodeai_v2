            ...
            <div className="md:w-[621%] md:max-w-[822px] flex flex-col gap-[30px] ">
              ...
              >
                ...
                <p className="text-[#9EB3CF] text-lg font-bwmss01">
                  ...
                  architecture. These tokens {"aren't"} derived from the image
                  data but are included to accumulate and refine essential
                  features across transformer layers. By balancing the attention
                  mechanism, these registers help mitigate the impact of
                  high-norm tokens and enhance the overall focus and efficacy of
                  the model.
                </p>
                <p className="text-[#9EB3CF] text-lg font-bwmss01">
                  ...
                  pitfalls in vision transformers, potentially revolutionizing
                  how we tackle various image-based tasks.
                </p>
                <p className="text-[#9EB3CF] text-lg font-bwmss01">
