            ...
            <div className="md:w-[621%] md:max-w-[822px] flex flex-col gap-[30px] ">
              ...
              >
                ...
                <p className="text-[#9EB3CF] text-lg font-bwmss01">
                  Recently, the paper {`"What Do Self-Supervised Vision
                  Transformers Learn?"`} caught my attention, and I decided to
                  write this short post for those new to Vision Transformers
                  (ViTs).
                </p>{" "}
                <p className="text-[#9EB3CF] text-lg font-bwmss01">
