          ...
          <div className="flex flex-col md:flex-row gap-[50px] ">
            ...
            <div className="md:w-[621%] md:max-w-[822px] flex flex-col gap-[30px] ">
              ...
              >
                ...
                <p className="text-[#9EB3CF] text-lg font-bwmss01">
                  1. The <b>authors do not show any experiments with real world
                  datasets,</b> not even the MNIST dataset which is the first
                  dataset beginners use when starting off with computer vision.
                  They only use toy examples, trying to fit the model to data
                  generated by complex mathematical equations (and do find
                  interesting results which you should check out in the paper).
                  <br />
                  2. The authors <b>{"don't"} give any details of training any network
                  deeper than 5 layers.</b> We may give them the benefit of the
                  doubt that there {"doesn't"} exist any optimized libraries
                  available to efficiently build deeper KANs, but the promise of
                  KANs is yet to be seen in real world applications, and whether
                  they can replace the already extremely efficient MLP.
                </p> 
                <p className="text-[#9EB3CF] text-lg font-bwmss01">
                The authors also do mention that training is <b>10x slower than MLPs,</b> which is the cost of learning more accurate and interpretable functions. While it is too soon to claim that this paper is as revolutionary as <i>backpropagation or attention is all you need,</i> there certainly seems potential in this novel approach of looking at neural networks. Let us know your thoughts in the comments and any interesting observations you got if you got a chance to use KANs!
                </p>
              </div>
              {/* end topic-5 */}
              {/* topic-6 */}
