            ...
            <div className="md:w-[621%] md:max-w-[822px] flex flex-col gap-[30px] ">
              ...
              >
                ...
                <p className="text-[#9EB3CF] text-lg font-bwmss01">
                  ...
                  Continuing my recent post about SiLU, {"let's"} explore
                  another activation function commonly used in LLMs: SwiGLU.
                  Introduced by{" "}
                  <a
                  ...
                  , the second author of the {`"Attention Is All You Need"`}{" "}
                  paper, SwiGLU has become the default activation function for
                  large-scale models like {"Google's"} PaLM, {"Meta's"} LLaMA,
                  and now {"Tencent's"} new Hunyuan model.
                </p>
              </div>
              ...
              >
                ...
                <p className="text-[#9EB3CF] text-lg font-bwmss01">
                  SwiGLU stands for Swish Gated Linear Unit. {"It's"} a variant
                  of the Gated Linear Unit (GLU) that incorporates the Swish
                  activation function into its gating mechanism.
                </p>
              </div>
              {/* end topic-2 */}
              ...
              >
                ...
                <p className="text-[#9EB3CF] text-lg font-bwmss01">
                  ...
                  performance, but its theoretical underpinnings are not yet
                  fully understood.
                  <br />
                  <br />
                  Link to the pager :{" "}
