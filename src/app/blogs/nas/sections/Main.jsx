            ...
            <div className="md:w-[621%] md:max-w-[822px] flex flex-col gap-[30px] ">
              ...
              >
                ...
                <p className="text-[#9EB3CF] text-lg font-bwmss01">
                  ...
                  . This exciting development in the field is all about
                  designing training-free proxies that can anticipate the
                  performance of a given architecture on a test dataset.
                </p>
